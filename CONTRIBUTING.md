...
| `chore`	     | Tarefas de manutenção que não afetam o código de produção ou testes.	| `chore: update dependencies`
| `perf`	     | Melhora de desempenho.	                                            | `perf: improve query performance`
